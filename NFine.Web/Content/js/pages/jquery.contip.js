...
; (function ($) {
    ...
    Contip.prototype = {
        ...
        html: function (opts) {
            ...
            opts = Object.assign({ html: this.options.html, bg: this.options.bg }, opts);
            $con.html(opts.html);
            //更新显示位置
            this.update(opts.bg);
        },
        ...
        update: function (bg) {
            ...
            this.offset(tip_w, tip_h, elm_w, elm_h, bg);
            return this;
        },

        // tip 气泡样式
        offset: function (tip_w, tip_h, elm_w, elm_h, bg) {
            var $tip = this.tip()
              , $v = $tip.find('.contip-v')
              , o = this.options
              , ofs = this.$elm.offset()
            ...
            switch (o.align) {
                ...
                case 'left':
                    ...
                    $tip.css({ left: tleft, top: ttop, background: o.bg });
                    return
